...
# 평균이 0 표준 편차가 1. Gaussian 분포를 따르는 잡음을 10의 7승 개 생성 합니다. 
n = np.random.randn(10**7)

# 'n' 배열의 첫 30개 값 , 소수점 아래 4자리까지
print("noise")
print(np.round(n[:30], 4))
r = x + n

# 'r' 배열의 첫 30개 값, 소수점 아래 4자리까지
print("r")
...
# noise 표준 편차를 0에서 2.9까지 0.1 간격으로 변경하면서 에러 확률 계산
